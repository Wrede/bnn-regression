...
from monochain_model import uniform_prior, simulator, monochain, newData, minmax_normalize, checkprior
...
def run_bnn(total_runs=5, num_rounds=8, num_data_per_round = 5_000, 
    ...
    try:
        ...
        for run in range(total_runs):
            ...
            #target_ts, min_, max_ = minmax_normalize(target_ts, min_=min_,
            #                                        max_=max_,axis=1)
            notscaled = False
